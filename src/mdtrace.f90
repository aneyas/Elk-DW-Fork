...
! Copyright (C) 2015 DW
! TODO: first, print the forces on atoms at each step.
! This file is distributed under the terms of the GNU General Public License.
! See the file COPYING for license details.

!This file, like the geometry optimization, shifts atoms according to the force on each atom and record the traces of shift of each
!atom.
...
do istp=1,maxlatvstp
  do jstp=1,maxatpstp
    if (mp_mpi) then
      write(*,'("Info(mdtrace): Atomic position trace&
       &steps : ",2I6)') istp,jstp
    end if
...
! update the atomic positions
    call atpstep
!TODO: Add how the atoms shift code here.
